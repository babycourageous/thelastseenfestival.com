...
gulp.task('serve', ['build:dev'], function() {
  ...
  gulp.watch('_performers/**/*.+(md|markdown|MD)', ['build:jekyll:serve']);
  gulp.watch('_shows/**/*.+(md|markdown|MD)', ['build:jekyll:serve']);
  gulp.watch('_workshops/**/*.+(md|markdown|MD)', ['build:jekyll:serve']);
